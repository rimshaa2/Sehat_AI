            ...
            const fetchAppointments = async () => {
                ...
                try {
                    ...
                    if (isActive && userProfile) {
                        ...
                        if (isActive) {
                            // Filter out pending payment review appointments
                                ...
                                >
                                    ...
                                    {dayApts.length > 0 && (
                                        <View style={styles.indicators}>
                                            ...
                                            {dayApts.length > 3 && <Text style={styles.moreDotsText}>+</Text>}
                                        </View>
                                    )}
                                </TouchableOpacity>
                            );
...
const styles = StyleSheet.create({
    ...
    calendarCard:                 { backgroundColor: "#FFF", borderRadius: 16, padding: 16, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2, marginBottom: 20 },
    calendarHeader:               { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 16 },
    monthName:                    { fontSize: 16, fontWeight: "700", color: "#0F172A" },
    headerControls:               { flexDirection: "row", alignItems: "center" },
    todayBtn:                     { backgroundColor: "#ECFDF5", paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, marginRight: 10 },
    todayText:                    { fontSize: 12, fontWeight: "700", color: "#10B981" },
    navBtn:                       { padding: 6, backgroundColor: "#F8FAFC", borderRadius: 8, marginLeft: 4 },
    weekdaysRow:                  { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: "#F1F5F9", paddingBottom: 8, marginBottom: 8 },
    weekdayText:                  { flex: 1, textAlign: "center", fontSize: 12, fontWeight: "700", color: "#94A3B8" },
    daysGrid:                     { flexDirection: "row", flexWrap: "wrap" },
    dayCellEmpty:                 { width: "14.28%", aspectRatio: 1, justifyContent: "center", alignItems: "center" },
    dayCell:                      { width: "14.28%", aspectRatio: 1, justifyContent: "center", alignItems: "center", borderBottomWidth: 1, borderBottomColor: "#F8FAFC" },
    dayCellSelected:              { backgroundColor: "#F0FDF4", borderRadius: 8 },
    dayNumberContainer:           { width: 28, height: 28, justifyContent: "center", alignItems: "center", borderRadius: 14 },
    dayNumberContainerToday:      { backgroundColor: "#199A8E" },
    dayNumberContainerSelected:   {},
    dayNumberText:                { fontSize: 14, fontWeight: "600", color: "#334155" },
    dayNumberTextToday:           { color: "#FFF" },
    dayNumberTextSelected:        { color: "#199A8E" },
    indicators:                   { flexDirection: "row", marginTop: 4, minHeight: 6, alignItems: "center" },
    dot:                          { width: 4, height: 4, borderRadius: 2, marginHorizontal: 1 },
    moreDotsText:                 { fontSize: 8, color: "#94A3B8", fontWeight: "bold", marginLeft: 1 },
    detailCard:                   { backgroundColor: "#FFF", borderRadius: 16, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2, overflow: "hidden" },
    detailHeader:                 { padding: 16, borderBottomWidth: 1, borderBottomColor: "#F1F5F9" },
    detailDateText:               { fontSize: 14, fontWeight: "700", color: "#0F172A" },
    detailCountText:              { fontSize: 12, color: "#64748B", marginTop: 2 },
    detailContent:                { padding: 16, minHeight: 150 },
    emptyState:                   { alignItems: "center", justifyContent: "center", paddingVertical: 32 },
    emptyTitle:                   { fontSize: 14, fontWeight: "600", color: "#334155", marginTop: 12 },
    emptyText:                    { fontSize: 12, color: "#94A3B8", marginTop: 4 },
    appointmentList:              { gap: 12 },
    appointmentItem:              { flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", backgroundColor: "#F8FAFC", padding: 12, borderRadius: 12, borderWidth: 1, borderColor: "#F1F5F9" },
    aptInfo:                      { flexDirection: "row", alignItems: "center", gap: 12 },
    aptDoctorInitial:             { width: 36, height: 36, backgroundColor: "#FFF", borderRadius: 10, borderWidth: 1, borderColor: "#E2E8F0", alignItems: "center", justifyContent: "center" },
    aptDoctorInitialText:         { fontSize: 14, fontWeight: "700", color: "#475569" },
    aptDoctorName:                { fontSize: 14, fontWeight: "700", color: "#0F172A" },
    aptTimeRow:                   { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 4 },
    aptTimeText:                  { fontSize: 12, color: "#64748B", fontWeight: "500" },
    aptStatusBadge:               { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6, borderWidth: 1 },
    aptStatusText:                { fontSize: 10, fontWeight: "700" },
});
