    ...
    <SafeAreaView style={styles.container}>
      ...
      >
          ...
          <View style={styles.profileCard}>
            ...
            {userData?.createdAt && (
              <Text style={styles.memberSince}>
                Member since {fmtDate(userData.createdAt)}
              </Text>
            )}
          </View>
        </View>
        ...
        <View style={styles.quickGrid}>
          ...
          >
            <View
              style={[styles.quickIconWrap, { backgroundColor: "#EEF2FF" }]}
            >
          ...
          >
            <View
              style={[styles.quickIconWrap, { backgroundColor: "#ECFDF5" }]}
            >
          ...
          >
            <View
              style={[styles.quickIconWrap, { backgroundColor: "#FEF3C7" }]}
            >
          ...
          >
            <View
              style={[styles.quickIconWrap, { backgroundColor: "#FCE7F3" }]}
            >
        ...
        <View style={styles.menuSection}>
          <View style={styles.menuCard}>
            ...
            >
              <View
                style={[styles.menuIconBox, { backgroundColor: "#EEF2FF" }]}
              >
            ...
            >
              <View
                style={[styles.menuIconBox, { backgroundColor: "#F5F3FF" }]}
              >
            ...
            >
              <View
                style={[styles.menuIconBox, { backgroundColor: "#ECFDF5" }]}
              >
