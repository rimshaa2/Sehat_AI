          ...
          {calendarDays.map((day, idx) => {
            ...
            return (
              <button
                ...
                className={`h-[90px] border-b border-r border-slate-50 p-2 text-left transition-all hover:bg-slate-50 relative group ${
                  isSelected ? "bg-[#199A8E]/5 ring-1 ring-[#199A8E]/20 ring-inset" : ""
                }`}
              >
                <span
